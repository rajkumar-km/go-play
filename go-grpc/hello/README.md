...
## Steps to develop a gRPC service/client
1. Create a Go module and define a service in a .proto file.
    - mkdir go-grpc
    - cd go-grpc/
    - go mod init github.com/rajkumar-km/go-play/go-grpc
    - mkdir server client hello    
    - Define the service in .proto file. See hello/hello.proto
2. Generate server and client stubs using the protocol buffer compiler (protoc).
    - protoc --go_out=. --go_opt=paths=source_relative \
             --go-grpc_out=. --go-grpc_opt=paths=source_relative \
             hello/hello.proto
    - Couple of go files are generated as a result and placed under grpc/
...
3. Use the Go gRPC API to write a simple client and server for your service.
    ...
    - Run the server
        ...
        2022/07/01 16:09:44 server listening at [::]:50051
    - Run client
        $ go run client/client.go
        2022/07/01 16:10:00 Greeting: Hello world
