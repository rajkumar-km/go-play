...
// PopCountV2 shifts the bits one by one instead of using a pc table
// PopCountV2 = took 17.7 ns/op in benchmark
...
// PopCountV3 shifts the bits one by one instead of using a pc table
// PopCountV3 = took 5.3 ns/op in benchmark
...
// different versions of popcount
func main() {
	if len(os.Args) != 2 {
	...
	fmt.Println("PopCountV3 =", PopCountV3(n))
}
