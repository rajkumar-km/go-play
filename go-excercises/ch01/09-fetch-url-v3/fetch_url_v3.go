/*
fetch_url_v3 fetches the given URL and prints the output. Includes the http:// prefix to the URL
if not provided. In addition, displays the http status code returned
